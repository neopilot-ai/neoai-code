...
const getArtifactUrl = (version: string) =>
  `https://github.com/neopilot-ai/neoai-vscode/releases/download/${version}/neoai-vscode.vsix`;
...
export function initMocks(): void {
  ...
  appName = sinon.stub(neoaiExtensionProperties, "isVscodeInsiders");
  installedVersion = sinon.stub(neoaiExtensionProperties, "version");
  betaChannelEnabled = sinon.stub(
    neoaiExtensionProperties,

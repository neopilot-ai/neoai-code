...
let currentLookAheadSuggestion: NeoaiInlineCompletionItem | undefined | null;
...
// and queries neoai with the selected item as prefix untitled-file-extension
...
async function enableTabOverrideContext(): Promise<Disposable> {
  await commands.executeCommand("setContext", "neoai.tab-override", true);
  return {
    dispose() {
